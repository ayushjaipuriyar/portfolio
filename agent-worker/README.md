...
## Connecting to the Portfolio Website

This agent is designed to work with the Next.js portfolio website. The website generates LiveKit access tokens and connects users to voice chat rooms where this agent provides AI assistance about the portfolio owner's experience, projects, and skills.
...
2. **Portfolio Data**: The agent loads portfolio information from `src/portfolio_data.py`. Update this file with the correct information or configure it to read from the website's API.
...
3. **Test the Voice Assistant**:
   ...
   - Click "Start Conversation" to connect to a LiveKit room
   - The agent will automatically join and respond to voice queries
...
Use function tools to retrieve specific information from the portfolio data.
