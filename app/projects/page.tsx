...
export const metadata = {
    title: "Projects",
    description: "Browse all projects by Ayush Jaipuriyar - Full Stack Software Engineer. Explore projects in distributed systems, microservices, machine learning, and cloud infrastructure.",
    alternates: {
