  ...
  return (
    <section className="bg-muted/20 px-4 py-16 sm:px-6 md:px-12 lg:px-24">
      <div className="mx-auto max-w-6xl">
        <h2 className="mb-8 text-center text-xl font-bold md:text-2xl">Technical Skills</h2>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {Object.entries(groupedSkills).map(([category, categorySkills]) => {
            ...
            return (
              <div
                key={category}
                className="group relative overflow-hidden rounded-lg border-2 border-border bg-card p-5 transition-all duration-300 hover:shadow-lg"
              >
