...
export function TileLayout({ chatOpen }: TileLayoutProps) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-32 top-8 z-50 md:bottom-40 md:top-12">
            ...
            <AnimatePresence mode="popLayout">
              {!isAvatar && (
                ...
                <MotionContainer
                  ...
                  className={cn(
                    ...
                    chatOpen && 'drop-shadow-lg/10 border-input/50 delay-200'
                  )}
                >
                  <BarVisualizer
                    barCount={5}
                  ...
                  >
                    <span
                      className={cn([
                        ...
                        'duration-250 origin-center transition-colors ease-linear',
              ...
              {isAvatar && (
                ...
                <MotionContainer
                  ...
                  className={cn(
                    'drop-shadow-xl/80 overflow-hidden bg-black',
