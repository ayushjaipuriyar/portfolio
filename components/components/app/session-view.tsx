...
export function Fade({ top = false, bottom = false, className }: FadeProps) {
  return (
    <div
      className={cn(
        'bg-linear-to-b pointer-events-none h-4 from-background to-transparent',
        top && 'bg-linear-to-b',
...
export const SessionView = ({
  ...
  const [chatOpen, setChatOpen] = useState(true); // Start with chat open by default
  ...
  return (
    <section className="relative z-10 h-full w-full overflow-hidden bg-background" {...props}>
      ...
      >
        ...
        <ScrollArea ref={scrollAreaRef} className="px-4 pb-[150px] pt-40 md:px-6 md:pb-[180px]">
          <ChatTranscript
            hidden={!chatOpen}
            messages={messages}
