  ...
  return (
    <div className={cn('flex items-center gap-0', className)}>
      <TrackToggle
        ...
        className="peer/track group/track has-[.audiovisualizer]:w-auto has-[~_button]:rounded-r-none has-[~_button]:pl-3 has-[~_button]:pr-2"
      >
        {audioTrackRef && (
          <BarVisualizer
            barCount={3}
      ...
      <hr className="relative z-10 -mr-px hidden h-4 w-px border-none bg-border has-[~_button]:block peer-data-[state=off]/track:bg-destructive/20" />
      <TrackDeviceSelect
        size="sm"
        kind={kind}
