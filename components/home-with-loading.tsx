...
const ScrollReveal = lazy(() =>
  import('@/components/scroll-reveal').then((mod) => ({ default: mod.ScrollReveal }))
);
const ConnectFooter = lazy(() =>
  import('@/components/sections/connect-footer').then((mod) => ({ default: mod.default }))
);
