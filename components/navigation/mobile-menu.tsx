        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 right-0 top-0 z-50 w-[min(280px,80vw)] border-l bg-background shadow-lg"
                    ...
                    {sections.map((section, index) => (
                      ...
                      >
                        <button
                          ...
                          className={cn(
                            'w-full rounded-lg px-4 py-4 text-left text-base transition-colors duration-200',
