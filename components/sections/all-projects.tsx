...
import { Tags, TagsEmpty, TagsGroup, TagsInput, TagsItem, TagsList } from '@/components/ui/shadcn-io/tags';
...
function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Link href={`/projects/${projectSlug}`} aria-label={`View ${project.title} details`}>
      <Card
        className="group relative flex h-full cursor-pointer flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
