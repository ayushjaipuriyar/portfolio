...
export function Hero({
  ...
  return (
    <section
      id="home"
      className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 py-20 sm:px-6 md:px-12 lg:px-24"
    >
      {/* <div className="absolute inset-0 pointer-events-none">
				<Meteors number={30} angle={145}/>
			</div> */}
      <motion.div
        initial={prefersReducedMotion ? 'visible' : 'hidden'}
        animate="visible"
        variants={containerVariants}
        className="relative z-10 flex w-full max-w-6xl flex-col items-center gap-6 text-center sm:gap-8 md:gap-12"
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-4">
          <RippleButton
            ...
            className="group relative min-h-[48px] overflow-hidden px-6 text-base transition-all duration-300 hover:scale-105 hover:shadow-lg sm:px-8 md:text-lg"
