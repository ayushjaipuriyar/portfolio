...
import { ExternalLink, Github, ArrowRight, CheckIcon, X } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className="relative h-44 w-full overflow-hidden bg-muted sm:h-48">
                ...
                <div
                    className={`absolute right-3 top-3 flex gap-2 transition-all duration-300 sm:right-4 sm:top-4 ${isHovered ? 'translate-y-0 opacity-100' : '-translate-y-2 opacity-0'
                        }`}
                >
                    {project.githubUrl && (
                        <a
            ...
            <CardFooter className="p-4 pt-0 sm:p-6 sm:pt-0">
                <div className="flex flex-wrap gap-1.5 sm:gap-2" role="list" aria-label="Technologies and tags">
        ...
        <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3].map((i) => (
                <Card key={i} className="overflow-hidden">
                    <div className="h-44 w-full bg-muted animate-pulse sm:h-48" />
                    <CardHeader className="p-4 sm:p-6">
